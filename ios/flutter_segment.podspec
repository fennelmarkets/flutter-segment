...
Library to let Flutter apps use Segment.io
                       DESC
  s.homepage         = 'https://github.com/fennelmarkets/flutter-segment'
  s.license          = { :type => 'MIT', :file => '../LICENSE' }
  s.author           = 'La Haus'
  s.source           = { :git => "https://github.com/fennelmarkets/flutter-segment.git", :tag => s.version.to_s }
  ...
  s.dependency 'segment-appsflyer-ios', :git => 'https://github.com/totzk9/segment-appsflyer-ios.git', :branch => 'master'
